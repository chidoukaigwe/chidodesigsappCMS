<template>
   ...
   <div class="jumbotron jumbotron-fluid" style="height: 500px">
        ...
        <div class="container mb-4 mt-4">
            ...
            <ul>
                <li><strong>Blogging Feature:</strong> Add image upload to article creation.</li>
                <li><strong>Blogging Feature:</strong> Tagging and Categorisation of articles.</li>
                <li><strong>Article Creation Page:</strong> Brainstorm and implement new additions for article creation page.</li>
                <li><strong>Dashboard:</strong> Add a dashboard events and display (logging of web app events) widget. </li>
